  ...
  return (
    <Box
      sx={{
        p: 4,
        background:
          "linear-gradient(180deg, #061622 40%, #018891 80%), linear-gradient(0deg, #018891, transparent)",
      }}
      id="learnings"
    >
      <Heading>Learnings</Heading>
      <SubHeading>What we know is the least we can learn</SubHeading>
