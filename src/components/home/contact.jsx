  ...
  return (
    <Box sx={{ mt: 10 }} id='contact'>
      <Container maxWidth='md' sx={{py: 4}}>
        <Typography variant='h4' className='text-darkblue lora' textAlign='center' sx={{mb: 3}}><Heading>Contact</Heading></Typography>
        <SubHeading>Lemme know what you think</SubHeading>
