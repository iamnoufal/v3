              ...
              {posts.map(post => {
                return (
                  <motion.div
                    ...
                    key={post.slug}
                  >
                    <Paper elevation={2} sx={{p:0, mb:2, background: 'linear-gradient(rgb(37 36 36), transparent), linear-gradient(transparent, rgb(37 36 36)), linear-gradient(130deg, #6610f2 10%, #6f42c1 20%, #d63384 35%, #dc3545 65%, #fd7e14 83%, #ff5607 96%)'}}>
