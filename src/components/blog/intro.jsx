  ...
  return (
    <Box
      sx={{
        minHeight: '100vh', 
        width: '100%', 
        backgroundImage: props.feature_image ? `url(${props.feature_image})` : 'linear-gradient(0deg, black, transparent 100%), linear-gradient(300deg, #08083a, transparent 21%), linear-gradient(198deg, rgba(255, 193, 7, 0.2) 11%, transparent 0%), linear-gradient(50deg, #6610f2 10%, #6f42c1 20%, #d63384 35%, #dc3545 65%, #fd7e14 83%, #ffc107 91%)',
    ...
    >
      ...
      >
        <Typography variant='h3' component="h1" sx={{mb:2}} className='text-white lora text-shadow' fontWeight={500}>{props.title}</Typography>
